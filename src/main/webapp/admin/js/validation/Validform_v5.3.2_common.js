...
(function(d, f, b) {
    ...
    var e = {
        ...
        w: {
            ...
            "URL": "请填写网址！",
            "Require" : "该项不允许为空！",
        	"Phone" : "请填写电话号码！",//可以带区号和分机号的固话 如+86-010-11111111-01
        	"Mobile" : "请填写手机号！",//可以匹配15 17 18等号段
        	"QQ" : "请填写QQ号！",//QQ 4到11位数字
        	"PositiveInt" : "请填写正整数！",//正整数
        	"Integer" : "请填写整数！",//整数
        	"Double" : "请填写浮点数！",//浮点数 
        	"IP" : "请填写IP地址！",//IP 地址
        	"IdCard" : "请填写身份证号！"//身份证
    ...
    a.util = {
        ...
        cssctl: function(l, k) {
            ...
            case 1:
                ...
                break;
            case 2:
                l.removeClass("Validform_wrong Validform_loading").addClass("ml10 mt5 Validform_checktip Validform_right");
                break;
            case 4:
                l.removeClass("Validform_right Validform_wrong Validform_loading").addClass("Validform_checktip");
                break;
            default:
                l.removeClass("Validform_right Validform_loading").addClass("ml10 mt5 Validform_checktip Validform_wrong")
            }
        },
