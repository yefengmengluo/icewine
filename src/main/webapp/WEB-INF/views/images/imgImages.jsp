...
/* 确认删除 */
 function doDelete(){
	...
	function page(n, s) {
     $("#pageNo").val(n);
     $("#pageSize").val(s);
     $("#searchForm").attr('action', '${ctx}/images.html').submit(); 
     return false;
 }
</script>
</head>
...
<div id="page-wrapper">
                ...
                <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
                    ...
                    <ol class="breadcrumb page-breadcrumb">
                        ...
                        <li><a href="#">图片管理</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
				...
				<tr>
					...
					<form action="${ctx }/images.html" method="post">
						<input type="text" class="text w150 fl" id="originalName" name="originalName" value="${imgImages.originalName }" placeholder="请输入标题" style="margin-left:20px;"/>
                                        ...
                                        <table class="table table-bordered table-striped table-condensed cf">
                                            <thead class="cf">
                                                <tr>
                                                    ...
                                                    <th class="numeric">存储路径</th>
                                                    <th class="numeric">原始名称</th>
                                                    <th class="numeric">图片编码</th>
                                            ...
                                            <c:forEach var="imgImagesVo" items="${page.list}">
                                                <tr>
                                                    <td><input type="checkbox" name="checkbox"/></td>
                                                    <td data-title="Code">${imgImagesVo.imgName }</td>
                                                    
                                                    
                                                   <td data-title="Price" class="numeric">${imgImagesVo.imgPath}</td> 
                                                   
                                                    <td data-title="Price" class="numeric">${imgImagesVo.originalName}</td>
                                                    <td data-title="Price" class="numeric">${imgImagesVo.id}</td>
                                                 ...
                                                 <a data-toggle="modal" onclick="deletenews(${imgImagesVo.id})"  data-target="#messageInfo" class="btn btn-danger btn-sm">删除</a>
                                                 </td> --%>&nbsp;&nbsp;                                                   
