...
<form action="${ctx }/register/company" method="post" id="memberAdverForm" autocomplete="off">
	
	<input type="hidden" id="proPath" value=""/>
	...
	<input type="hidden" id="inviterAccount" name="inviterAccount" value="null"/>
            ...
            <div id="RegForm" class="form accountForm">
                ...
                <div id="o-password">
                    ...
                    <div class="item cf">
                        ...
                        <div class="fl item_info">
                        <input type="password" class="text" id="double_pass" name="double_pass" datatype="*" recheck="password" maxlength="16" nullmsg="请再输入一次密码" errormsg="您两次输入的账号密码不一致"  />
                        	<label class="info" style="display: none;color:#666;">
                                	请再次输入密码
                            </label>
...
<!-- <div class="special_service">
    <div class="ss_title">单品通尊享服务<a href="http://plw.99114.com/dpt/" target="_blank"><img src="/static/images/dp.gif" width="24" height="20" /></a></div>
    <div class="service_con">
        ...
        <!--企业注册accountInfo end-->
        <!--企业注册 begin-->
        <div class="ygRegist company_regist form">
        	<div class="hv_show hide"></div>
        	<div class="perTitle perTitle_comInfo">
            	<span></span>
            </div>
            <div class="accountInfo">
            	<div id="comInfo" class="form">
                	<div id="select_regName" class="item cf">
                        <span class="label"><em class="fontRed mr5">*</em>公司名称：</span>
                        <div class="fl item_info">
                         <input type="text" class="text text2" datatype="lkz2-60" nullmsg="请输入公司名称" maxlength="50" errormsg="请输入工商注册名称，个体经营者按姓名+个体经营" id="corporationName" name="corporationName" onkeydown="return banInputSapce(event,this);" />
                            <label class="info" style="display: none;color:#666;">
                                                                请输入工商注册名称，个体经营者按姓名+个体经营
                            </label>
                            </div>
                    </div>
                 <!--    <div class="item2 cf h52 hhh">
                    	<span class="label"><em class="fontRed mr5">*</em>所在地址：</span>
                    	<div>
                          <div class="d-select" id="dvroot">
                                       <div class="slt-chk"><input type="text" class="slt-input" value="请选择"  id='ipt_devroot_show'/>
										<a href="javascript:" class="slt-btn"></a></div>
				 							<input type="hidden" id="ipt_dvroot" value="" name="ipt_dvroot"/>
				 							<input type="hidden"  id="areaCode" name="areaCode"/>
				 							<ul class="slt-option"></ul>
                    ...
                    <div class="item form cf">
                    	<span class="label"><em class="fontRed mr5">*</em>联系人姓名：</span>
                        <div class="fl item_info">
                            <input type="text"  maxlength="16" class="text text2" name="linkMan" datatype="lkz2-20" nullmsg="请输入姓名" errormsg="姓名为中文或字母，长度2-16个字符" />
                            <label class="info" style="display: none;color:#666;">
                                                                    姓名为中文或字母，长度2-16个字符
                            </label>
                        </div>
                ...
                <div id="divMobile" >
                    <div class="item cf"  >
                        <span class="label laltit"><em class="fontRed mr5">*</em>手机：</span>
                         <div class="fl item_info">
                        	<div class="telval">
                               <input type="text" class="text" datatype="m" maxlength="11" nullmsg="手机号不能为空"  errormsg="请输入有效手机号码，如以1开头，11位纯数字"  id="mobile" name="mobile"/>
                               <label class="info" style="display: none;color:#666;">
                                                                    请输入有效手机号码，如以13开头，11位纯数字
                                </label>
                    ...
                    <div class="item cf">
                        ...
                        <div class="fl item_info mb20">
                           <input  type="text" id="vcode" name="vcode"  autocomplete="false"  class="text yzm_item_text"   maxlength="6" onclick="codeImage()" onmouseover="this.style.borderColor='#41d6d6'" onmouseout="this.style.borderColor=''">
                   ...
                   <!--  <div class="item cf">
                    ...
                    <div class="item cf" style="display: none;" id="inviteDiv">
	                	<span class="label">邀请码：</span>
	                    <div class="intelligent_regName">
	                    <div class="fl item_info">
	                    	  <input type="text" disabled="disabled" class="inputCl"/>
	                          <span class="Validform_checktip">邀请人账号</span>
	                        </div> 
	                    </div>
	                </div>
                </div>
...
<script type="text/javascript" src="${ctx }/register/js/register.js"></script>
