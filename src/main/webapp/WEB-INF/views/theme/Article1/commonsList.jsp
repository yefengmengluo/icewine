...
<!-- <meta name="decorator" content="left"/> -->
...
<script type="text/javascript">
	...
	function page(n, s) {
		$("#pageNo").prop("value", n);
		$("#searchForm").prop('action', "${ctx }/more/commonsList.html")
				.submit();
		return false;
	}
...
<body>
	...
	<div class="wrapper">
		...
		<div class="location mt10 mb10">
			<h6>
				您的当前位置：<a href="${ctx}/index.html">中国冰酒交易网</a> &gt;&gt; <em>冰酒常识</em>
			</h6>
		</div>
		<!-- 当前位置 -->
	</div>
		...
		<div class="newsLeft h1309">
			...
			<div class="detail2 articleList">
				...
				<c:forEach var="articleVo" items="${page.list }">
					...
					<dl>
						<dt>
							<a href="${ctx }/newDetial/commonDe.html?id=${articleVo.id}">${articleVo.title}</a><span>${fn:substring(articleVo.addTime,0,10)}</span>
						</dt>
