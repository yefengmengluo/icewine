					...
					<div class="portlet box portlet-yellow">
						...
						<div class="portlet-body">
							<form action="${ctx }/front/member/supply/save.html" name="supplystmentEditForm" id="supplystmentEditForm" method="post" onclick="checkpost()" enctype="multipart/form-data" class="form-validate form-horizontal">
								  <input type="hidden" name="id" value="${prosupply.id }" >
								<div class="form-group">
									<label for="" class="col-md-2 control-label"><span
										style="color: red">*</span>标题名称:</label>
									<div class="col-md-5">
										<input type="text" id="name" name="name" value="${prosupply.name }"
                              ...
                              <div class="form-group">
									...
									<div class="col-md-5">
										<input type="text" id="priceMin" name="priceMin" value="${prosupply.priceMin }"
											class="form-control required" /> <span id="namespan"></span>
									</div>
								...
								<div class="form-group">
									...
									<div class="col-md-5 ">
										<input name="files" type="file" class=""
											...
											name="pic" type="hidden" value="${prosupply.pic }">
                                 ...
                                 <div class="form-group">
									...
									<div class="col-md-5">
										<input id="addTime" readonly="readonly" name="addTime" 
											class="form-control" value="${prosupply.addTime }"
								...
								<div class="form-group">
									...
									<div class="col-md-5">
										<input type="text" id="unit" name="unit" value="${prosupply.unit }"
							    ...
							    <div class="form-group">
									...
									<div class="col-md-5">
										<input type="text" id="storeNum" name="storeNum" value="${prosupply.storeNum }"
											class="form-control required" /> <span
											id="urlspan"></span>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-5">
										<input type="text" id="promotionType" name="promotionType" value="${prosupply.promotionType }"
											class="form-control required" /> <span
											id="urlspan"></span>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-5">
										<input type="text" id="priceInner" name="priceInner" value="${prosupply.priceInner }"
											class="form-control required" /> <span
											id="urlspan"></span>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-11 ">
										<textarea name="summary" value="${prosupply.summary }"  rows="20" class="form-control"></textarea>
									</div>
								</div>
								<div class="form-group">
