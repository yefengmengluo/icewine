...
<!-- 当前位置 -->
      <div class="location mt10 mb10">
          <h6>您的当前位置：<a href="${ctx}/index.html">中国冰酒交易网</a> &gt;&gt;<a href="${ctx}/front/article/list.html"><em>冰酒资讯</em>&gt;&gt;<em>酿制工艺</em></a></h6>
      </div>
    <!-- 当前位置 -->   
</div>
<div class="wrapper">
    <div class="newsLeft">
	   <div class="title"><h3>酿制工艺</h3></div>
	   <div class="detail2">
	      <div class="artTxt">
        ...
        <div class="about">
          ...
          <ul>
           <c:forEach var="articleListVo" items="${makeList }" begin="0" end="11">
           
           <li><a href="${ctx }/newDetial/makeDetail.html?id=${articleListVo.id}" target="_blank">${articleListVo.title }</a></li>
