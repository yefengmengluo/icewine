...
<!-- 当前位置 -->
      <div class="location">
          <h6>您的当前位置：<a href="${ctx}/index.html">中国冰酒交易网</a><span>友情链接</span></h6>
      </div>
    <!-- 当前位置 -->   
</div>
<div class="wrapper">
    ...
    <div class="copyright_left_title"><img src="${ctx}/media/Images/Copyright/menu_top.gif" width="207" height="10" alt="" /></div>
             <div class="copyright_left_center">
                ...
                <div class="copyright_menu floatl">
                    ...
                    <li class="litit">关于我们</li>
                        ...
                        <li><a href="${ctx }/link.html">友情链接</a><span>Links</span></li>
                    </ul>        
                </div>
     ...
     <div class="copyright_right floatr">
       	<div class="copyright_right_title "><h1>友情链接</h1></div> 
        <div class="copyright_xian">
        	<p><img width="731" height="121" alt="" src="${ctx}/media/Images/Copyright/top.jpg"></p>
            <div class="textLink mt10">
                <p>文字链接</p>
                <div>
                    <a href="http://www.99114.com">中国网库</a>
                    <a href="http://www.tieta.99114.com">中国铁塔交易网</a>
                    <a href="http://www.zhongzi.99114.com">中国种子交易网</a>
                                                               
                </div>
            </div>
            <div class="cls"></div>
            <div class="textLink textLink2 mt10">
                <p>友情申请</p>
                <h2>友情链接申请条件：</h2>
                <ul>
                    <li>1.您的网站交换链接的页面PR值>=5</li>
                    <li>2.您的网站不包含盗版、黄色等不良内容</li>
                    <li>如果您希望交换友情链接,并符合以上条件,欢迎联系我们</li>
                    <li>E-mail：yujinhe@99114.com</li>
                </ul>
                <div class="cls"></div>
            </div>        
            <div class="cls"></div>        
