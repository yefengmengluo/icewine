	...
	var editor1 = K.create('textarea[name="content"]', {
		...
		afterCreate : function() {
			...
			K.ctrl(document, 13, function() {
				self.sync();
				document.forms['advertiseEditForm'].submit();
			});
				...
				<div class="col-lg-12">
					<div class="portlet box portlet-yellow">
						...
						<div class="portlet-body">
							<form action="${ctx }/advertise/save.html"
								name="advertiseEditForm" id="advertiseEditForm" method="post"
								...
								<div class="form-group">
									...
									<div class="col-md-5">
										<input type="text" id="title" name="title"
											value="${advertises.title }" class="form-control required" />
								...
								<div class="form-group">
									...
									<div class="col-md-5">
										<input type="text" id="biref" name="biref"
											value="${advertises.biref }" class="form-control required" />
										<span id="urlspan123456"></span>
									</div>
								</div>

								<div class="form-group">
									<label class="col-md-1 control-label"
										style="padding-left: 0px;"> 发布时间： </label>
									<div class="col-md-5">
										<input id="date" readonly="readonly" name="addTime"
											value="${advertises.addTime }" class="form-control"
								...
								<div class="form-group">
									...
									<div class="col-md-5 ">
										<input name="files" type="file" class="form-control"
											...
											name="img" value="${advertises.img }" type="hidden">
								...
								<div class="form-group">
									...
									<div class="col-md-5">
										<input type="text" id="imgUrl" name="imgUrl" value="${advertises.imgUrl }"
                             ...
                             <span style="color: #ff0000" id="urlspan"></span>
								...
								<div class="form-group">
									...
									<div class="col-md-11 ">
										<textarea name="content" rows="20" class="form-control">${advertises.content}</textarea>
									</div>
                                ...
                                <div class="form-group">
			                     <label class="col-md-1 control-label">
			                        ...
			                        <div class="col-md-5">
			                        	...
			                        	<%-- <option  ${advertises.dataStatus == '2'?'selected':"" } value="2">已通过</option> --%>
										<option  ${advertises.flag == '16'?'selected':"" } value="16">置顶</option>
									    <option  ${advertises.flag == '8'?'selected':"" } value="8">推荐</option>
									     <option  ${advertises.flag == '1'?'selected':"" } value="1">单品通推荐</option>
