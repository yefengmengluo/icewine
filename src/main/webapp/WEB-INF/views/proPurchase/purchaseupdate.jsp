							...
							<form name="purchaseEditForm" id="purchaseEditForm"
								...
								<div class="form-group">
									...
									<div class="col-md-5">
										<input type="radio" name="invoiceRequest"
											style="margin-top: 10px;" value="0" 
											${proPurchase.invoiceRequest eq "0" ? "checked":"" } />不需要发票
										&nbsp;&nbsp;&nbsp;&nbsp; <input type="radio"
											name="invoiceRequest" style="margin-top: 10px;" value="1"
											${proPurchase.invoiceRequest eq "1" ? "checked":"" } />普通发票
										&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio"
											name="invoiceRequest" style="margin-top: 10px;" value="2"
								...
								<div class="form-group">
									...
									<div class="col-md-5">
										...
										&nbsp;&nbsp;&nbsp;&nbsp; <input type="radio"
											name="sampleRequest" style="margin-top: 10px;" value="1"
								...
								<div class="form-group">
									...
									<div class="col-md-5">
										<select name="status" id="status" class="form-control">
											...
											<option value="-1"
												${proPurchase.status == '-1' ? 'selected':'' }>取消推荐</option>
											<option value="-2"
												${proPurchase.status == '-2' ? 'selected':'' }>取消置顶</option>
											<%--<option value="1"
											...
											<option value="8"
												${proPurchase.status == '8' ? 'selected':'' }>推荐</option>
											<option value="16"
