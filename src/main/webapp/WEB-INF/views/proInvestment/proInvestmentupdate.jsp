							...
							<form 
								...
								<div class="form-group">
									...
									<div class="col-md-5">
										<input type="text" id="name" name="name"
											class="form-control required" value="${proInvestment.name}" />
								...
								<div class="form-group">
									...
									<div class="col-md-5 ">
										<input name="files" type="file" class=""
											...
											name="pic" value="${proInvestment.pic }" type="hidden">
								...
								<div class="form-group">
									...
									<div class="col-md-5">
										<select id="siteId" name="siteId" class="form-control">
											<option value="1" ${proInvestment.siteId == '1' ? 'selected':'' }>1万以下 </option>
											<option value="2" ${proInvestment.siteId == '2' ? 'selected':'' }>1—3万</option>
											<option value="3" ${proInvestment.siteId == '3' ? 'selected':'' }>3—10万</option>
											<option value="4" ${proInvestment.siteId == '4' ? 'selected':'' }>10—30万</option>
											<option value="5" ${proInvestment.siteId == '5' ? 'selected':'' }>30万以上</option>
										</select>
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-md-5">
										<select name="status" id="status" class="form-control" >
											...
											<option value="-1"
												${proInvestment.status == '-1' ? 'selected':'' }>取消推荐
											</option>
											<option value="-2"
												${proInvestment.status == '-2' ? 'selected':'' }>取消置顶
											</option>
											<option value="8"
								...
								<div class="form-group">
									<div class="col-md-offset-3 col-md-10">
										<input class="btn btn-success" onclick="doupdate()" type="button" value="保存">
